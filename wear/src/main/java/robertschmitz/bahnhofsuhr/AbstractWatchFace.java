...
public abstract class AbstractWatchFace extends CanvasWatchFaceService {
    ...
    private final long INTERACTIVE_UPDATE_RATE_MS = 1000 / getInteractiveFPS();

    private final WatchFaceRenderer mWatchFaceRenderer = getWatchFaceRendererInstance();
    ...
    /**
     * @return The desired frames per seconds
     */
    protected abstract int getInteractiveFPS();

    protected abstract WatchFaceRenderer getWatchFaceRendererInstance();
    ...
    private class Engine extends CanvasWatchFaceService.Engine {
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            mTime = new Time();
            mWatchFaceRenderer.onCreate(resources);
        }
        ...
        public void onPropertiesChanged(Bundle properties) {
            ...
            mWatchFaceRenderer.onAmbientModeChanged(mAmbient, mLowBitAmbient);
        }
        ...
        public void onDraw(Canvas canvas, Rect bounds) {
            mTime.setToNow();
            mWatchFaceRenderer.renderWatchFace(mTime, canvas, bounds, mAmbient);
        }
